...
function Chapter8() {
  return (
    <div>
      ...
      <SectionTitle>Training Resources</SectionTitle>

      <a
        href="https://randomnerdtutorials.com/?s=Cheap+Yellow+Display"
        target="_blank"
        rel="noopener noreferrer"
        className="flex items-center justify-between gap-4 p-4 rounded-xl border border-gray-700 bg-gray-900/60 hover:border-green-500/60 hover:bg-gray-800/60 transition-all group mb-4"
      >
        <div>
          <h4 className="text-white font-semibold text-sm mb-1 group-hover:text-green-400 transition-colors">
            Cheap Yellow Display (CYD) Tutorials
          </h4>
          <p className="text-gray-400 text-xs leading-relaxed">
            RandomNerdTutorials guides for the ESP32-based Cheap Yellow Display — wiring, programming, and project walkthroughs.
          </p>
        </div>
        <LinkOut size={16} className="text-gray-500 group-hover:text-green-400 shrink-0 transition-colors" />
      </a>
    </div>
  )
}
